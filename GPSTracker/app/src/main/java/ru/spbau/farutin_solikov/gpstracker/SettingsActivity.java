...
public class SettingsActivity extends AppCompatPreferenceActivity {
	private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
		...
		public boolean onPreferenceChange(Preference preference, Object value) {
			...
			e.putString(preference.getKey(), preference.getSummary().toString());
			e.apply();
	...
	public static class GeneralPreferenceFragment extends PreferenceFragment {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			// guidelines.
			bindStringPreferenceSummaryToValue(findPreference("example_text"));
			bindStringPreferenceSummaryToValue(findPreference("example_list"));
		}
	...
	public static class NotificationPreferenceFragment extends PreferenceFragment {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			bindBooleanPreferenceSummaryToValue(findPreference("notifications_new_message"));
			bindBooleanPreferenceSummaryToValue(findPreference("notifications_light"));
		}
	...
	public static class UserIDPreferenceFragment extends PreferenceFragment {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			findPreference("user_id").setSummary(sharedPreferences.getString("deviceId", ""));
			...
			quit.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
				...
				public boolean onPreferenceClick(Preference preference) {
					...
					builder.setTitle("Change device ID?");
					builder.create().show();
